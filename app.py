...
# Import custom styling module
from styles import (
    apply_custom_styles, render_login_header, render_main_header, 
    render_user_info, render_sidebar_header, render_metric_card,
    render_mood_display, render_reply_display, render_alert,
    render_loading_spinner, render_section_header, render_footer
)
...
with col_nav1:
    render_user_info(st.session_state.username)
...
if st.session_state.analytics_data:
    ...
    # Using styled metric cards from styles module
...
# Main Content Area
render_section_header("Customer Message Analysis Center", "🎯")
